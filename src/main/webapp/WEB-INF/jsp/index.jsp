...
<link rel="stylesheet" href='<c:url value="/resources/jQuery-File-Upload/css/jquery.fileupload-ui.css"/>'>
...
<div class="container">
    ...
    <form id="fileupload" action="<c:url value="/upload/multifile"/>" method="POST" enctype="multipart/form-data">
...
<script src='<c:url value="/resources/jQuery-File-Upload/js/jquery.fileupload-fp.js"/>'></script>
<!-- The File Upload user interface plugin -->
<script src='<c:url value="/resources/jQuery-File-Upload/js/jquery.fileupload-ui.js"/>'></script>
<!-- The localization script -->
<script src='<c:url value="/resources/jQuery-File-Upload/js/locale.js"/>'></script>
<!-- The main application script -->
<script src='<c:url value="/resources/jQuery-File-Upload/js/main.js"/>'></script>
<!-- The XDomainRequest Transport is included for cross-domain file deletion for IE8+ -->
<!--[if gte IE 8]><script src='<c:url value="/resources/jQuery-File-Upload/js/cors/jquery.xdr-transport.js"/>'></script><![endif]-->
</body> 
</html>
